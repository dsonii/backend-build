...
const busSchema = new mongoose.Schema({
    ...
    certificate_pollution_expiry_date: { type: Date },
    certificate_insurance: { type: String },
    certificate_insurance_expiry_date: { type: Date },
...
busSchema.statics = {
    ...
    transformData(item) {
        return {
            ...
            certificate_pollution_expiry_date: item.certificate_pollution_expiry_date,
            certificate_insurance: item.certificate_insurance,
            certificate_insurance_expiry_date: item.certificate_insurance_expiry_date,
            certificate_fitness: item.certificate_fitness,
            certificate_fitness_expiry_date: item.certificate_fitness_expiry_date,
            certificate_permit: item.certificate_permit,
            certificate_permit_expiry_date: item.certificate_permit_expiry_date,
            status: item.status,
